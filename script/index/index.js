...
$(function () {
  ...
  $('.section_3>div').mouseenter(function () {
    $(this).css({ "width": "58%", "transition": "all 1s" });
    $(this).siblings("div").css({ "width": "38%", "transition": "all 1s" });
  });

  $('.section_3>div').mouseleave(function () {
    $(this).css({ "width": "48%", "transition": "all 1s" });
    $(this).siblings("div").css({ "width": "48%", "transition": "all 1s" });
  });
  //subscript
});